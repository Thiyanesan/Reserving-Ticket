...
;
$find=$_GET['find'];
$query = "select * from train where TrainSource='$find';";
...
<main><?php
 ...
 <th>NUMBER</th>&nbsp&nbsp&nbsp<th>NAME</th>&nbsp&nbsp&nbsp<th
>ARRIVAL</th>&nbsp&nbsp&nbsp<th>DEPARTURE</th>&nbsp&nbsp&nbsp<th>
SOURCE</th>&nbsp&nbsp&nbsp<th>DESTINATION</th>
 <?php }
